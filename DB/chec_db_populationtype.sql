...
CREATE TABLE `populationtype` (
  `ï»¿Sno` int DEFAULT NULL,
  `PupulationType` text,
  `PopulationTypeID` text
...
INSERT INTO `populationtype` VALUES (1,'Rural','PT_1'),(2,'Population under 30,000','PT_2'),(3,'Population 30,000 to 99,999','PT_3'),(4,'Population 100,000 to 499,999','PT_4'),(5,'Population 500,000 and over','PT_5'),(6,'Cities','PT_6');
