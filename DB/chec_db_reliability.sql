...
CREATE TABLE `reliability` (
  `idreliability` int NOT NULL,
  `reliabilityType` text,
  `reliabilityDesc` text,
  PRIMARY KEY (`idreliability`)
...
INSERT INTO `reliability` VALUES (1,'A','Excellent'),(2,'B','Very good'),(3,'C','Good'),(4,'D','Fair (Use with Caution)');
